...
/*
1.	Gsearch seems to be the biggest driver of this business. CEO of the company asked to pull monthly 
trends for gsearch sessions and orders so that she can showcase the growth there? 
*/ 
...
/*
2.	Next, CEO thinks that it would be great to see a similar monthly trend for Gsearch, but this time splitting out nonbrand 
and brand campaigns separately. She is wondering if brand is picking up at all. If so, this is a good story to tell. 
*/ 
...
/*
3.	CEO asked you to dive into nonbrand, and pull monthly sessions and orders split by device type? 
*/ 
...
/*
4.	CEO asked to pull monthly trends for Gsearch, alongside monthly trends for each of our other channels?
*/ 
...
/*
5.	CEO asked you to pull session to order conversion rates, by month? 
...
from each of the two pages to orders. Use the same time period you analyzed last time (Jun 19 – Jul 28).
*/ 
...
/*
8.	CEO wants you to quantify the impact of our billing test, as well. Please analyze the lift generated 
